  ...
  <header style="background: #003f2d; border-bottom: 1px solid rgba(255,255,255,0.1); padding: 15px 0;">
    <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
      ...
      <div style="display: flex; gap: 15px; align-items: center;">
        ...
        <a href="https://buy.stripe.com/test_aFabJ01EGbPz6tn8UYeME00" target="_blank" rel="noopener" class="btn-primary" style="background: #f59e0b; color: #000; font-weight: 800; text-decoration: none; padding: 8px 16px; border-radius: 6px; font-size: 0.85rem;">€49 Survey →</a>
      </div>
    </div>
  </header>
  ...
  <section class="loc-hero">
    <div class="container">
      <div style="max-width: 850px; margin: 0 auto; text-align: center;">
        ...
        <a href="https://buy.stripe.com/test_aFabJ01EGbPz6tn8UYeME00" target="_blank" rel="noopener" class="btn-primary" style="background: #f59e0b; color: #000; font-weight: 800; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-size: 1.1rem; display: inline-block;">Book ${town.name} €49 Independent Survey →</a>
      </div>
    </div>
  </section>
